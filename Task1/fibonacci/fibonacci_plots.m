% Plots needed for the Fibonacci method
...
for lambda=linspace(0.005,0.15,size) 
    i = i + 1;
    [a,b,k(i),l(i)] = fibonacciM(f_1,lambda);
end
subplot(3,1,1)
...
for lambda=linspace(0.005,0.15,size)
    i = i + 1;
    [a,b,k(i),l(i)] = fibonacciM(f_2,lambda);
end
subplot(3,1,2)
plot(l,k,'-r','LineWidth',1.4)
...
for lambda=linspace(0.005,0.15,size)
    i = i + 1;
    [a,b,k(i),l(i)] = fibonacciM(f_3,lambda);
end
subplot(3,1,3)
plot(l,k,'-r','LineWidth',1.4)
